...
<body>
            ...
            <div class="us_container ">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="box">
                            <div class="img-box">
                                <img src="Images/u-1.png" alt="" width="60">
                            </div>
                            <div class="detail-box">
                                <h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="box">
                            <div class="img-box">
                                <img src="Images/u-4.png" alt="" width="60">
                            </div>
                            <div class="detail-box">
                                <h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="box">
                            <div class="img-box">
                                <img src="Images/u-2.png" alt="" width="60">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Pagina intuitiva.
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="box">
                            <div class="img-box">
                                <img src="Images/u-3.png" alt="" width="60">
                            </div>
                            <div class="detail-box">
                                <h5>
    ...
    <footer class="container-fluid footer_section">
        <p>
            ...
            <a>Grupo 2-Fidelitas (ISAAC ESPINOZA, TAYRON GUZMAN, BUNTARO OLIVARES, MAURICIO MARIN)</a>
        </p>
    </footer>
    <!-- footer section -->
