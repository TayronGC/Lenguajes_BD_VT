...
<body>
  ...
  <main class="bg-gray-100 py-12">
    <div class="container mx-auto">
      ...
      <form action="/controllers/ProveedorController.php" method="POST" class="bg-white p-8 shadow-md rounded-lg">
        ...
        <div class="mb-4">
          <label for="id_estado" class="block text-gray-700 font-bold">ID Estado</label>
          <input type="number" id="id_estado" name="id_estado" class="w-full px-4 py-2 border rounded-lg">
        </div>
