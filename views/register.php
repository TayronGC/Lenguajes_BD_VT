        ...
        <div class="card bg-dark text-light p-4 shadow-lg" style="max-width: 400px; width: 100%; border-radius: 10px;">
            ...
            <form action="index.php?controller=Usuario&action=register" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-dark text-light border-0" placeholder="Ingrese su usuario" id="nombre_usuario" name="nombre_usuario" required>
                </div>
                <div class="mb-3">
                    <label for="correo" class="form-label">Correo Electrónico:</label>
                    <input type="email" class="form-control bg-dark text-light border-0" placeholder="Ingrese su Email" id="correo" name="correo" required>
                </div>
                <div class="mb-3">
                    <label for="contrasena" class="form-label">Contraseña:</label>
                    <input type="password" class="form-control bg-dark text-light border-0" placeholder="Ingrese su contraseña" id="contrasena" name="contrasena" required>
                </div>
