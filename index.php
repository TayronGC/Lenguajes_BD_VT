    ...
    <section class="container mx-auto py-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
          ...
          <a href="index.php?controller=Promocion&action=index" class="bg-green-500 text-white py-2 px-4 rounded-full inline-block hover:bg-green-600">Acceder</a> class="bg-green-500 text-white py-2 px-4 rounded-full inline-block hover:bg-green-600">Acceder</a>
        </div>
